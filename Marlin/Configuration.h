...
#define STRING_CONFIG_H_AUTHOR "(Christian Axelsson, MM3 config)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 99 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION (X_BED_SIZE - MIN_PROBE_EDGE-7)
  #define FRONT_PROBE_BED_POSITION MIN_PROBE_EDGE+24
